#
# Minimal scrooge-like API using gevent and running within the parent process.
#
import datetime
import heapq
import logging
...
logger = logging.getLogger("scrooge.mini")


class MiniScroogeResult(AsyncResult):
    __call__ = AsyncResult.get


class MiniScrooge(object):
    def __init__(self, name="scrooge", interval=1, pool_size=None):
        self.name = name
    ...
    def task(self, validate_func=None):
        ...
        def decorator(fn):
            ...
            def _inner(*args, **kwargs):
                async_result = MiniScroogeResult()
